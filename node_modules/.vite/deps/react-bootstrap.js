...
function map(children, func) {
  let index = 0;
  return React8.Children.map(children, (child) => React8.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React8.Children.toArray(children).some((child) => React8.isValidElement(child) && child.type === type);
}
...
function useDropdownMenu(options = {}) {
  const context2 = (0, import_react7.useContext)(DropdownContext_default);
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react8.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react8.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react8.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react8.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var DropdownItem = React13.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
...
var DropdownContext2 = React15.createContext({});
...
var DropdownItem2 = React16.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var FormSelect = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime34.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames20.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var Switch = React33.forwardRef((props, ref) => (0, import_jsx_runtime36.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = React42.forwardRef(({
  ...
  const renderBackdrop = (0, import_react25.useCallback)((backdropProps) => (0, import_jsx_runtime46.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React43.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
var Overlay = React44.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react27.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react28.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React47.forwardRef(({
  ...
  const popperRef = (0, import_react29.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react29.useState)(null);
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react30.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react30.useRef)("");
  ...
  const handleHide = (0, import_react30.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react30.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react30.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react30.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react30.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react30.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime54.jsxs)(import_jsx_runtime53.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react30.cloneElement)(children, triggerProps), (0, import_jsx_runtime52.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ProgressBar = React53.forwardRef(({
  ...
  return (0, import_jsx_runtime60.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react31.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context2 = (0, import_react32.useContext)(TabContext_default);
  if (!context2)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react33.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react33.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastFade = React65.forwardRef((props, ref) => (0, import_jsx_runtime75.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React67.forwardRef(({
  ...
  const context2 = (0, import_react34.useContext)(ToastContext_default);
...
var Toast = React68.forwardRef(({
  ...
  const delayRef = (0, import_react35.useRef)(delay);
  const onCloseRef = (0, import_react35.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react35.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react35.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToggleButton = React70.forwardRef(({
  ...
  return (0, import_jsx_runtime82.jsxs)(import_jsx_runtime81.Fragment, {
    children: [(0, import_jsx_runtime80.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime80.jsx)(Button_default2, {
      ...props,
      ref,
